...
function buildMockLogs(): readonly LogLine[] {
  ...
  return [
    ...
    err(32, 2, "7tbsm", "db connection refused: dial tcp 10.0.0.4:5432: i/o timeout", "req_b81k4m"),
    ...
    err(32, 22, "7tbsm", "db query failed: pq: too many connections for role 'app'", "req_a3f9c2"),
    info(32, 27, "a3kx2", "POST /api/orders 201 in 87ms", "req_d2j5q8"),
    err(32, 32, "7tbsm", "request timeout after 30000ms", "req_b81k4m"),
    info(32, 38, "m9p4r", "Healthcheck OK"),
    err(32, 43, "7tbsm", "db connection refused: dial tcp 10.0.0.4:5432: i/o timeout", "req_a3f9c2"),
    ...
    err(33, 1, "7tbsm", "upstream pool exhausted, dropping request", "req_b81k4m"),
    info(33, 7, "m9p4r", "POST /api/sessions 201 in 64ms", "req_e6h1v3"),
    err(33, 12, "7tbsm", "db query failed: context deadline exceeded", "req_a3f9c2"),
    info(33, 18, "a3kx2", "Healthcheck OK"),
    err(33, 23, "7tbsm", "request timeout after 30000ms", "req_b81k4m"),
    warn(33, 29, "7tbsm", "Health endpoint returned 503 (degraded)"),
    info(33, 35, "m9p4r", "GET /api/notifications 200 in 49ms", "req_e6h1v3"),
    err(33, 41, "7tbsm", "db connection refused: dial tcp 10.0.0.4:5432: i/o timeout", "req_a3f9c2"),
    info(33, 47, "a3kx2", "GET /api/orders 200 in 51ms", "req_d2j5q8"),
    err(33, 53, "7tbsm", "upstream pool exhausted, dropping request", "req_a3f9c2"),
    warn(33, 59, "7tbsm", "Active requests in flight: 47 (limit 50)"),

    err(34, 5, "7tbsm", "db query failed: pq: too many connections for role 'app'", "req_b81k4m"),
    info(34, 11, "m9p4r", "GET /api/users 200 in 44ms", "req_e6h1v3"),
    err(34, 17, "7tbsm", "request timeout after 30000ms", "req_a3f9c2"),
    info(34, 23, "a3kx2", "PATCH /api/orders/52 200 in 71ms", "req_c4n7p9"),
    err(34, 29, "7tbsm", "db connection refused: dial tcp 10.0.0.4:5432: i/o timeout", "req_b81k4m"),
    warn(34, 35, "7tbsm", "Background job 'session-cleanup' failed: db unreachable"),
    info(34, 41, "m9p4r", "Heartbeat sent"),
    err(34, 47, "7tbsm", "upstream pool exhausted, dropping request", "req_b81k4m"),
    info(34, 53, "a3kx2", "POST /api/orders 201 in 84ms", "req_d2j5q8"),
    err(34, 59, "7tbsm", "db query failed: context deadline exceeded", "req_a3f9c2"),
    ...
    err(35, 17, "7tbsm", "db connection refused: dial tcp 10.0.0.4:5432: i/o timeout", "req_b81k4m"),
    info(35, 23, "a3kx2", "GET /api/orders 200 in 53ms", "req_c4n7p9"),
    err(35, 29, "7tbsm", "request timeout after 30000ms", "req_a3f9c2"),
    warn(35, 35, "7tbsm", "Health endpoint returned 503 (degraded)"),
    info(35, 41, "m9p4r", "GET /api/notifications 200 in 48ms", "req_e6h1v3"),
    err(35, 47, "7tbsm", "upstream pool exhausted, dropping request", "req_b81k4m"),
    info(35, 53, "a3kx2", "GET /api/orders/53 200 in 50ms", "req_d2j5q8"),
    err(35, 59, "7tbsm", "db query failed: pq: too many connections for role 'app'", "req_a3f9c2"),

    warn(36, 5, "7tbsm", "Initiating rollback to srv-7tbsm@8f4d29"),
    err(36, 11, "7tbsm", "request timeout after 30000ms", "req_b81k4m"),
    info(36, 17, "m9p4r", "POST /api/uploads 201 in 148ms", "req_e6h1v3"),
    err(36, 23, "7tbsm", "db connection refused: dial tcp 10.0.0.4:5432: i/o timeout", "req_a3f9c2"),
    ...
    err(36, 47, "7tbsm", "upstream pool exhausted, dropping request", "req_b81k4m"),
